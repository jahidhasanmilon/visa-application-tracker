...
export default function LoginGate() {
  return (
    <AuthLayout
      ...
      sub="One workspace for staff to manage cases and applicants to check exactly where they stand — no spreadsheets, no guessing."
      stats={[
    ...
    >
      ...
      <div className="app-role-grid">
        <Link to="/login/staff" className="app-role-card">
          ...
          <div style={{ flex: 1 }}>
            <div className="app-role-title">Staff / Admin</div>
